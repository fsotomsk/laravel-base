...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @param null $trap404
     */
    public function mapControllers(Router $router, $classes, $trap404=null)
    {
        $routes = [];
        ...
        foreach ($classes as $class) {
            ...
            $name = str_replace('App\\Http\\Controllers\\', '', $class->name);
    ...
    protected function mapWebRoutes()
    {
        Route::group([
            ...
            try {
                ...
                $this->mapControllers($router, $classes);

                $pages = Page::indexed();
                foreach($pages as $page) {
                    $params = [
                        'as'         => $page->id,
                        'uses'       => 'Page\\' . ( $page->controller ?: 'Main@view' ),
                        'page'       => $page,
                        'middleware' => [],
                    ];
    ...
    protected function mapApiRoutes()
    {
        Route::group([
            ...
            try {
                ...
                $this->mapControllers($router, $classes, 'Main@error404');
            } catch (\Exception $e) {}
        });
    }
}
